...
def _strided_from_memmap(
    ...
    if strides is None:
        ...
        return make_memmap(
            filename, dtype=dtype, shape=shape, mode=mode, offset=offset, order=order
        )
    else:
...
class ArrayMemmapReducer(object):
    ...
    def __init__(self, max_nbytes, temp_folder, mmap_mode, verbose=0, prewarm=True):
    ...
    def __call__(self, a):
        ...
        if (
            ...
            if self.verbose > 1:
                print("Pickling array (shape={}, dtype={}).".format(a.shape, a.dtype))
...
def get_memmapping_reducers(
    ...
    **kwargs
    ...
    pool_folder_name = "joblib_memmapping_folder_{}_{}".format(os.getpid(), pool_id)
    pool_folder, use_shared_mem = _get_temp_dir(pool_folder_name, temp_folder)
    ...
    def _cleanup():
        ...
        try:
            ...
            warnings.warn("Failed to clean temporary folder: {}".format(pool_folder))
