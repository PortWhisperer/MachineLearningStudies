    ...
    def compressor_file(self, fileobj, compresslevel=None):
        ...
        if compresslevel is None:
            ...
            return self.fileobj_factory(
                fileobj, "wb", format=lzma.FORMAT_ALONE, preset=compresslevel
            )
...
class XZCompressorWrapper(LZMACompressorWrapper):
    ...
    def compressor_file(self, fileobj, compresslevel=None):
        ...
        if compresslevel is None:
            ...
            return self.fileobj_factory(
                fileobj, "wb", check=lzma.CHECK_NONE, preset=compresslevel
            )
...
class LZ4CompressorWrapper(CompressorWrapper):
    ...
    def _check_versions(self):
        if not PY3_OR_LATER:
            raise ValueError("lz4 compression is only available with " "python3+.")
