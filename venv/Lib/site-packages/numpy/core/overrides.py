...
def array_function_implementation_or_override(
    ...
    if (
        not overloaded_args
        or types == _NDARRAY_ONLY
        or all(
            type(arg).__array_function__ is _NDARRAY_ARRAY_FUNCTION
    ...
    for overloaded_arg in overloaded_args:
        ...
        result = overloaded_arg.__array_function__(public_api, types, args, kwargs)
    ...
    raise TypeError(
        ...
        "__array_function__: {}".format(func_name, list(map(type, overloaded_args)))
    )
