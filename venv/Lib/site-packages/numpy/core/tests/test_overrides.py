...
requires_array_function = pytest.mark.skipif(
    not ENABLE_ARRAY_FUNCTION, reason="__array_function__ dispatch not enabled."
)
...
class TestGetOverloadedTypesAndArgs(object):
    ...
    def test_ndarray_subclasses(self):
        ...
        types, args = get_overloaded_types_and_args([override_sub, no_override_sub])
    ...
    def test_ndarray_subclass_and_duck_array(self):
        ...
        assert_equal(
            _get_overloaded_args([array, subarray, other]), [subarray, array, other]
        )
        assert_equal(
            _get_overloaded_args([array, other, subarray]), [subarray, array, other]
        )
